        ...
        <div className="col-start-1 col-end-9 p-3 rounded-lg">
            <div className="flex flex-row items-start">
                ...
                <div className="relative ml-3 text-sm bg-black bg-opacity-25 pt-3 pb-2 px-4 shadow rounded-xl">
                    <canvas ref={canvasRef} width={1024} height={1024} onMouseDown={onMouseDown} onMouseMove={onMouseMove} onMouseUp={onMouseUp} />
                    {/* <img src={imageUrl} alt={alt ? alt : 'Sin alt'} className="rounded-xl w-96 h-96 object-cover" onClick={() => onImageSelected && onImageSelected(imageUrl)} /> */}
                    <button onClick={resetCanva} className="btn-primary mt-2">Borrar Selección</button>
                </div>
            </div>
        </div>
    )
